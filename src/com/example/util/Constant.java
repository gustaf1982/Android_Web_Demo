...
public class Constant implements Serializable{
	...
	public static final String SERVER_IMAGE_CATEGORY="http://playfoxgames.com/news/upload/category/";
 	//this is the path of uploaded image of newslist thumb
	public static final String SERVER_IMAGE_NEWSLIST_THUMBS="http://playfoxgames.com/news/upload/thumbs/";
 	//this is the path of uploaded image of news list
	public static final String SERVER_IMAGE_NEWSLISTDETAILS="http://playfoxgames.com/news/upload/";
	...
	public static final String LATEST_URL = "http://playfoxgames.com/news/api.php?latest_news=10";
	//this url gives list of category in 2nd tab
	public static final String CATEGORY_URL = "http://playfoxgames.com/news/api.php";
	//this url gives item of specific category.
	public static final String CATEGORY_ITEM_URL = "http://playfoxgames.com/news/api.php?cat_id=";
	//this url gives your company details
	public static final String COMPANY_DETAILS_URL = "http://playfoxgames.com/news/api.php?apps_details";
